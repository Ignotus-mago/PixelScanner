...
public class DiagonalZigzagGen extends PixelMapGen {
	 ...
	 * The description variable should shadow the abstract class variable. 
	 */
	public final static String description = "DiagonalZigzagGen genearates a diagonal zigzag map starting at (0,0). Moves first to (0,1) then proceeeds diagonally from edge to edge. "
